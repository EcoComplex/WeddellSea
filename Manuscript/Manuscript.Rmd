...
First of all, it's important to note that since the proportion of Jacobians that are locally stable is zero for the Weddell Sea food web, we considered the real part of the maximum eigenvalue as the stability index. Our results showed that the majority of the species had no significant impact on the stability of the food web when extinct (Anderson-Darling test p-value > 0.01 for QSS difference). This is clearly observed in Figure 6 A-D, where most of the points lie around the zero value of the 'QSS difference' axis. This means that the stability for the food web minus a given species is similar to the stability for the whole network.
