...
```{r, out.width = "12cm", echo = FALSE, fig.cap = "Map of the Weddell Sea and Dronning Maud Land sector indicating the approximate location of the study area (black star, 74-78ºS) within the high Antarctic shelf. Modified from www.soos.aq."}
knitr::include_graphics("Fig1_StudyMap_ok.png")
```
