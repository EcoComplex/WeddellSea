...
\codedataavailability{R code and data set used in this work is available
at
https://github.com/EcoComplex/WeddellSea} %% use this section when having data sets and software code available
