...
```{r echo=FALSE, fig.align='center', fig.cap="Figure 1. Map of the Weddell Sea and Dronning Maud Land sector highlighting the high Antarctic shelf as a dashed-line contour. Modified from www.soos.aq."}

library(knitr)
knitr::include_graphics("Fig.1_StudyMap.jpg", dpi = 600)
...
```{r echo=FALSE, fig.align='center', fig.cap="Figure 2. Scheme of a network showing the weighted and unweighted properties we used to characterize the species of the Weddell Sea food web."}

library(knitr)
knitr::include_graphics("Fig.2_ToyFoodWeb.jpg", dpi = 600)
...
The statistical distribution that best fitted the empirical interaction strength distribution was a ‘gamma’ due to the high proportion of weak interactions and the existence of a few strong interactions (Figure 3, Table S3).

```{r echo=FALSE, fig.align='center', fig.cap="Figure 3. Frequency distribution of interaction strengths for the Weddell Sea food web. Total number of interactions = 16041. The distribution was best fitted to a ‘gamma’ model."}

library(knitr)
knitr::include_graphics("Fig3_IntDist.png", dpi = 600)
...
library(knitr)
knitr::include_graphics("Fig4_LinReg.png", dpi = 600)
...
```{r echo=FALSE, fig.align='center', fig.cap="Figure 5. Stability  difference (mean maximum eingenvalue) between the whole Weddell Sea food web (n = 490) and the food web minus one species (n = 489) for weighted (interaction strength) and unweighted species properties, and habitat. Point color indicates the impact on the stability; if significant the extinction of that species altered the stability of the food web."}

library(knitr)
knitr::include_graphics("Fig.5_QSSDif.png", dpi = 600)
