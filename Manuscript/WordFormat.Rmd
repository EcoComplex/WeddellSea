...
```{r echo=FALSE, fig.align='center', fig.cap="Figure 3. Frequency distribution of interaction strengths for the Weddell Sea food web. Total number of interactions = 16041."}
...
load("../Manuscript/ModelFit.rda")
knitr::kable(IS_fit %>% arrange(., deltaAIC), digits = c(0,0,2,2), col.names = c("Model", "df", "AIC", "deltaAIC"), caption = "Model comparison for the distribution of interaction strengths of the Weddell Sea food web. Order by best fit. References: df = degrees of freedom, AIC = Akaike Information Criterion, deltaAIC = difference with best fit. Log-Normal is the best model.")
