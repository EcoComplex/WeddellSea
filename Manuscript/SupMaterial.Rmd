...
knitr::kable(all_dif %>% dplyr::select(TrophicSpecies, IS_median,IS_Q1,IS_Q3, TotalDegree, TL, meanTrophicSimil) %>% arrange(., desc(IS_median)), digits = c(0,7,7,7,0,2,3), col.names = c("Species","median IS","Q1 IS", "Q3 IS", "Degree", "TL", "TS"), caption = "Weighted (interaction strength) and unweighted properties of the species of Weddell Sea food web. Ordered by decreasing mean interaction strength. mean IS = median interaction strength, Q1 IS = First quantil of the IS distribution, Q3 IS = Third quantil of the IS distribution, TL = trophic level, TS = trophic similarity.")
